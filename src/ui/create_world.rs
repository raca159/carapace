...
pub fn spawn_ui(mut commands: Commands, mut ui: ResMut<UiEntities>, params: Res<WorldGenParams>) {
    let seed_text = format!("Seed: {}", params.seed);
    let size_text = format!("Size: {} x {}", params.width, params.height);
    ...
    let root = commands
        ...
        .with_children(|parent| {
            ...
            parent.spawn((
                Text("Press ENTER to continue  |  ESC to go back  |  R to randomize seed".to_string()),
